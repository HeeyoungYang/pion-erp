      ...
      <v-row>
        <v-col cols="12">
          <table style="width:100%">
            <tr>
              <td class="approve_title" style="width:10%" >담당자</td>
              <td class="approve_text" style="width:15%" ></td>
              <td class="approve_title" style="width:10%" >연락처</td>
              <td class="approve_text" style="width:15%" ></td>
              <td class="approve_title" style="width:10%" >email</td>
              <td class="approve_text" style="width:15%" ></td>
            </tr>
            <tr>
              <td class="approve_title" style="width:10%" >결제조건</td>
              <td class="approve_text" style="width:15%" ></td>
              <td class="approve_title" style="width:10%" >리드타임</td>
              <td class="approve_text" style="width:15%" ></td>
              <td>
                <v-btn small color="primary" class="ml-3" @click="orderPurchaseDialog = true">발주서</v-btn>
              </td>
            </tr>
            <tr>
            </tr>
...
export default {
  ...
  data(){
    return{
      ...
      inbound_approve_headers:PurchaseSearchPageConfig.inbound_approve_headers,
      inbound_product_list_headers:PurchaseSearchPageConfig.inbound_product_list_headers,
      ...
      survey_cost_headers: PurchaseSearchPageConfig.survey_cost_headers,
      search_tab_items: PurchaseSearchPageConfig.search_tab_items,
      labor_cost_headers: PurchaseSearchPageConfig.labor_cost_headers,
      calc_cost_detail_data: JSON.parse(JSON.stringify(PurchaseSearchPageConfig.calc_cost_detail_data)),
      inbound_approve_data:PurchaseSearchPageConfig.test_inbound_approve_data
    }
  },
